...
int main(int argc, char **argv){
    ...
    int    result;
    int    functionType = HistogramAnalyzer::kNone;
    bool   isLeft = false;
    ...
    for (int i = 1; i<=9; i++){
        ...
        HistogramAnalyzer::Get().FitSliceSingleSide(hist,x,xerr,sig,chi2,prob,result,functionType,-1,isLeft);
        ...
        hist->Draw();
        HistogramAnalyzer::Get().DrawFitting(hist,functionType,0,0,isLeft);
