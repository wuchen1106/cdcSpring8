...
int main(int argc, char ** argv){
    ...
    printf("i/I ic1/I ic2/I ic3/I cz_1st_1 cz_1st_2 cz_1st_3 cz_2nd_1 cz_2nd_2 cz_2nd_3 cx_1st_1 cx_1st_2 cx_1st_3 cx_2nd_1 cx_2nd_2 cx_2nd_3\n");
    for (int i = 0; i<ichain->GetEntries(); i++){
        ...
        if (iev==pre_iev){
            ...
            if (i!=0) printf("%d %d %d %d %.3e %.3e %.3e %.3e %.3e %.3e %.3e %.3e %.3e %.3e %.3e %.3e\n",pre_iev,min_icombi[0],min_icombi[1],min_icombi[2],min_chi2z[0],min_chi2z[1],min_chi2z[2],min2_chi2z[0],min2_chi2z[1],min2_chi2z[2],min_chi2x[0],min_chi2x[1],min_chi2x[2],min2_chi2x[0],min2_chi2x[1],min2_chi2x[2]);
